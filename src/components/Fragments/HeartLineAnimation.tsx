...
import "./HeartRateAnimation.css"; // Importando os estilos

const HeartRateAnimation: React.FC<{className: string}> = ({className}) => {
  return (
    <div className={className}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 502.98 108.61">
        <path
          id="heart"
